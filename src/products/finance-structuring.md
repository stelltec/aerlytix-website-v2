...
<article class="section__product section__spacing-3">
  <div class="container">
    <div class="row gx-lg-5 featurette">
      <div class="col-md-7">
        <h2 class="h1">‘Solve for’ Debt Structuring Tools</h2>
        <p class="display-7">Define and analyze unlimited single and multi tranche loans in seconds, quickly ‘solving for’ advance, fixed payment, or balloons.</p>
      </div>
...
<article class="section__product section__spacing-3">
  <div class="container">
    <div class="row gx-lg-5 featurette">
      <div class="col-md-7">
        <h2 class="h1">Existing Loan Upload </h2>
        <p class="display-7">Upload any existing loan schedule into Aerlytix from Excel via. CSV, to capture contracted loan changes in seconds.</p>
      </div>
      <div class="card col-md-5">
        <img src="https://placehold.co/600x400" width="600" height="400" />
      </div>
...
<article class="section__product section__spacing-3">
  <div class="container">
    <div class="row gx-lg-5 featurette">
      <div class="col-md-7">
        <h2 class="h1">Loan-to-Value (‘LTV’) Interface</h2>
        <p class="display-7">Interactive LTV monitoring system for debt service coverage, current and maturity status’.</p>
      </div>
      <div class="card col-md-5">
        <img src="https://placehold.co/600x400" width="600" height="400" />
      </div>
